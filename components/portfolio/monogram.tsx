...
const BIRD_TRANSFORM = '-translate-x-[20%] translate-y-[4%]';
...
export function Monogram({
  ...
  return (
    <span className={cn('inline-flex flex-col items-center', className)}>
      {withBird && <img src='/logo-new.svg' alt='' aria-hidden className={cn('block w-auto relative z-10', s.bird, BIRD_TRANSFORM)} />}
