...
export const metadata = { title: 'Over Kristian — meubelmaker in Noord-Holland', description: 'Maak kennis met Kristian, oprichter en maker achter Studio Phazant. Meubels op maat met hergebruikt en lokaal gewonnen hout.' };
