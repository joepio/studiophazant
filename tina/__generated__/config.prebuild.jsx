...
import React3, { useState, useContext } from "react";
...
// components/icon.tsx
var IconOptions = {
  Tina: (props) => React4.createElement("svg", { ...props, viewBox: "0 0 66 80", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, React4.createElement("title", null, "Tina"), React4.createElement(
    "path",
    {
...
var Icon = ({ data, parentColor = "", className = "", tinaField: tinaField8 = "" }) => {
  ...
  if (style == "circle") {
    return React4.createElement(
      ...
      React4.createElement(IconSVG, { className: "w-2/3 h-2/3" })
    );
  } else {
...
var IconPickerInput = wrapFieldsWithMeta2(({ input }) => {
  ...
  const filteredBlocks = React5.useMemo(() => {
  ...
  return React5.createElement("div", { className: "relative z-[1000]" }, React5.createElement("input", { type: "text", id: input.name, className: "hidden", ...input }), React5.createElement(Popover, null, ({ open }) => React5.createElement(React5.Fragment, null, React5.createElement(PopoverButton, null, React5.createElement(Button, { className: `text-sm h-11 px-4 ${InputIcon ? "h-11" : "h-10"}`, size: "custom", rounded: "full", variant: open ? "secondary" : "white" }, InputIcon && React5.createElement(InputIcon, { className: "w-7 mr-1 h-auto fill-current text-blue-500" }), inputLabel, !InputIcon && React5.createElement(BiChevronRight, { className: "w-5 h-auto fill-current opacity-70 ml-1" }))), React5.createElement("div", { className: "absolute w-full min-w-[192px] max-w-2xl -bottom-2 left-0 translate-y-full", style: { zIndex: 1e3 } }, React5.createElement(
    Transition,
    {
    ...
    React5.createElement(PopoverPanel, { className: "relative overflow-hidden rounded-lg shadow-lg bg-white border border-gray-150 z-50" }, ({ close }) => React5.createElement("div", { className: "max-h-[24rem] flex flex-col w-full h-full" }, React5.createElement("div", { className: "bg-gray-50 p-2 border-b border-gray-100 z-10 shadow-sm" }, React5.createElement(
      "input",
      {
        type: "text",
    ...
    )), filteredBlocks.length === 0 && React5.createElement("span", { className: "relative text-center text-xs px-2 py-3 text-gray-300 bg-gray-50 italic" }, "No matches found"), filteredBlocks.length > 0 && React5.createElement("div", { className: "w-full grid grid-cols-6 auto-rows-auto p-2 overflow-y-auto" }, React5.createElement(
      "button",
      {
      ...
      React5.createElement(GoCircleSlash, { className: "w-6 h-auto text-gray-200" })
...
var AnimationComponent = React8.memo(({ segment, variants, per, segmentWrapperClassName }) => {
  const content = per === "line" ? React8.createElement(motion2.span, { variants, className: "block" }, segment) : per === "word" ? React8.createElement(
    motion2.span,
    {
      "aria-hidden": "true",
      variants,
    ...
    segment
  ) : React8.createElement(motion2.span, { className: "inline-block whitespace-pre" }, segment.split("").map((char, charIndex) => React8.createElement(
    motion2.span,
    {
      key: `char-${charIndex}`,
      "aria-hidden": "true",
  ...
  return React8.createElement("span", { className: cn(defaultWrapperClassName, segmentWrapperClassName) }, content);
});
...
var MermaidElement2 = dynamic(() => Promise.resolve().then(() => (init_mermaid_renderer(), mermaid_renderer_exports)), {
  ssr: false,
...
var ReactPlayer = dynamic2(() => import("react-player"), { ssr: false });
...
var config = defineConfig({
  ...
  schema: {
    collections: [project_default, page_default, global_default]
  }
});
